...
router.post('/favorito', usuarioLogadoMiddleware.validateToken, favoritoMiddleware.validateIdUsuario, favoritoMiddleware.validateFavorito, favoritoMiddleware.validateExisteUsuario,favoritoController.createFavorito);
